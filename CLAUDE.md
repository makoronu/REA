...
|------|------|
| 作業中 | なし |
| 完了 | チラシ・マイソクPhase 0完了（土地用テンプレート、API、フォーマット関数） |
| 残り | チラシ・マイソクPhase 1（戸建・マンション・収益テンプレート）、ZOHO画像同期、定期同期 |
| 最終更新 | 2025-12-15 |
| 備考 | API: `/api/v1/flyer/maisoku/{id}` (SVG/PNG)、設計: `docs/flyer/README.md` |
