...
**実装手順**:
- [ ] Phase 1: DB変更（column_labelsにvisible_for追加）+ 初期データ投入
- [ ] Phase 2: フロントエンド対応（DynamicFormでフィルタリング）
- [ ] Phase 3: バックエンド対応（バリデーション調整）
- [ ] Phase 4: 管理画面作成（/admin/field-visibility）
