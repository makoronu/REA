...
"""
            ...
            for file_info in summary["files"]:
                if (
                    file_info.get("lines", 0) > 50
                    or len(file_info.get("classes", [])) > 0
                ):
    ...
    def _generate_dependency_analysis(self, files: list) -> str:
        ...
        for file_info in files:
            ...
            for imp in imports:
                ...
                if any(
                    keyword in module
                    for keyword in ["rea", "shared", "generators", "analyzers"]
                ):
        ...
        sorted_internal = sorted(
            internal_counts.items(), key=lambda x: x[1], reverse=True
        )
