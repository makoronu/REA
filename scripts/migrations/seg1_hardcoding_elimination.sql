...
WHERE column_name = 'room_floor' AND table_name = 'building_info';

-- 戸建 → 総戸数不要
UPDATE column_labels SET conditional_exclusion = '{"depends_on": "property_type", "exclude_when": ["detached"]}'
WHERE column_name = 'total_units' AND table_name = 'building_info';
...
WHERE column_name = 'setback' AND table_name = 'land_info';

-- 3-3: special_flag_key 設定
UPDATE column_labels SET special_flag_key = 'no_road_access' WHERE column_name = 'road_info' AND table_name = 'land_info';
